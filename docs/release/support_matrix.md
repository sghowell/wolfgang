...
| Apple Metal accelerator | Source-build evidence | Apple M4 Pro source-build reports through Apple Metal Wave 1D (commutation) and Campaign 8 (simplify) | Metal wheels remain unavailable | Generic Apple GPU support is unavailable; evidence is local Apple M4 Pro source-build evidence |
